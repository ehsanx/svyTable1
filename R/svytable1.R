...
#' )
#'
#' # Basic survey-weighted Table 1, stratified by hypertension status.
#' svytable1(
#'   design = design,
#'   strata_var = "htn",
#'   table_vars = c("age", "sex", "race", "smoking")
#' )
#'
#' # With NCHS reliability checks plus a detailed metrics table. Estimates that
#' # fail the reliability rules are shown as "*".
#' results <- svytable1(
#'   design = design,
#'   strata_var = "htn",
#'   table_vars = c("age", "sex", "race", "smoking"),
...
#' head(results$reliability_metrics)
